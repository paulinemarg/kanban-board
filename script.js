...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    backlogListArray = ['Finish React course', 'Take a vacation'];
    progressListArray = ['Update existing projects', 'Bake a cake'];
    completeListArray = ['Finish advanced JS', 'Run errands'];
    onHoldListArray = ['Writing blog'];
  }
}
